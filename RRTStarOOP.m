function [pathWPX, pathWPY] = RRTStarOOP(roverObject)
...
startPoint.coord = [roverObject.startPoint(1) roverObject.startPoint(2)];      
startPoint.cost = 0;
startPoint.parent = 0; 
goalPoint.coord = [roverObject.targetPoint(1) roverObject.targetPoint(2)];
goalPoint.cost = 0;
...
pathWPX = flip(pathWPX);   % Start to goal WP coords in X
pathWPY = flip(pathWPY);   % Start to goal WP coords in Y
%---------------------------------------------------------------------%
%%%%% END
%---------------------------------------------------------------------%
end
